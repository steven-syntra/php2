...
abstract class AbstractCSVExport
{
    ...
    abstract public function Generate(); //generate output

    abstract protected function PrintBody(); //make body (data)

    abstract protected function PrintColumnHeadings(); //make column headings
